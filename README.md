...
[![Version](https://shields.io/badge/Version-0.7.7-blue)](https://github.com/tamada/totebag/releases/tag/v0.7.7)
[![MIT License](https://shields.io/badge/License-MIT-blue)](https://github.com/tamada/totebag/blob/main/LICENSE)
[![docker](https://shields.io/badge/Docker-0.7.7-blue?logo=docker)](https://github.com/tamada/totebag/pkgs/container/totebag)
...
```sh
docker run -it --rm -v $PWD:/workdir ghcr.io/tamada/totebag:0.7.7 [OPTIONS] [ARGUMENTS]...
```
