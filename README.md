...
[![Version](https://shields.io/badge/Version-0.8.1-blue)](https://github.com/tamada/totebag/releases/tag/v0.8.1)
[![MIT License](https://shields.io/badge/License-MIT-blue)](https://github.com/tamada/totebag/blob/main/LICENSE)
[![Docker](https://shields.io/badge/Docker-0.8.1-blue?logo=docker)](https://github.com/tamada/totebag/pkgs/container/totebag)
...
```sh
docker run -it --rm -v $PWD:/workdir ghcr.io/tamada/totebag:0.8.1 [OPTIONS] [ARGUMENTS]...
```
